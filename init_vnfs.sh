...
echo client
son-emu-cli compute start -d dc1 -n client -i rubis --net '(id=client-eth0,ip=10.0.0.10/24)'
...
echo web
son-emu-cli compute start -d dc2 -n server -i rubis --net '(id=server-eth0,ip=10.0.0.50/24)'
