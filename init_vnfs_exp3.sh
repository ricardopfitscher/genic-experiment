...
echo client
son-emu-cli compute start -d dc1 -n client -i rjpfitscher/genic-vnf --net '(id=client-eth0,ip=10.0.0.10/24)'
...
echo web
son-emu-cli compute start -d dc2 -n server -i rjpfitscher/genic-vnf --net '(id=server-eth0,ip=10.0.0.50/24)'
